...
Task: answer the pack-specific demo question for Jellyfin Media Server Pack.

Use only this scoped Contextarr export summary for pack jellyfin-media-server-pack.

Sources:

- records/overview.md: Public-safe starter context for a fictional self-hosted Jellyfin media server.
