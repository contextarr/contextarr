...
Task: answer the pack-specific demo question for GitHub Workflow Pack.

Use only this scoped Contextarr export summary for pack github-workflow-pack.

Sources:

- records/overview.md: Public-safe starter context for fictional GitHub repository workflows.
