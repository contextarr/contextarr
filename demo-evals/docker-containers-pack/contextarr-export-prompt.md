...
Task: answer the pack-specific demo question for Docker Containers Pack.

Use only this scoped Contextarr export summary for pack docker-containers-pack.

Sources:

- records/overview.md: Public-safe starter context for fictional Docker container operations.
