...
Task: answer the pack-specific demo question for VS Code Setup Pack.

Use only this scoped Contextarr export summary for pack vscode-setup-pack.

Sources:

- records/overview.md: Public-safe starter context for a fictional VS Code developer setup.
