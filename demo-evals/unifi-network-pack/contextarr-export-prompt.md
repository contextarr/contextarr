...
Task: answer the pack-specific demo question for UniFi Network Pack.

Use only this scoped Contextarr export summary for pack unifi-network-pack.

Sources:

- records/overview.md: Public-safe starter context for a fictional UniFi network.
