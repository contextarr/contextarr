...
Task: answer the pack-specific demo question for AWS Infrastructure Pack.

Use only this scoped Contextarr export summary for pack aws-infrastructure-pack.

Sources:

- records/overview.md: Public-safe starter context for fictional AWS infrastructure documentation.
