...
Task: answer the pack-specific demo question for Google Workspace Pack.

Use only this scoped Contextarr export summary for pack google-workspace-pack.

Sources:

- records/overview.md: Public-safe starter context for organizing fictional Google Workspace knowledge.
