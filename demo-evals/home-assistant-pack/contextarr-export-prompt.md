...
Task: answer the pack-specific demo question for Home Assistant Pack.

Use only this scoped Contextarr export summary for pack home-assistant-pack.

Sources:

- records/overview.md: Public-safe starter context for a fictional Home Assistant installation.
