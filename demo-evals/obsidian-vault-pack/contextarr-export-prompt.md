...
Task: answer the pack-specific demo question for Obsidian Vault Pack.

Use only this scoped Contextarr export summary for pack obsidian-vault-pack.

Sources:

- records/overview.md: Public-safe starter context for a fictional local Markdown knowledge vault.
