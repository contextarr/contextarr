...
Task: answer the pack-specific demo question for AI Workstation Pack.

Use only this scoped Contextarr export summary for pack ai-workstation-pack.

Sources:

- records/overview.md: Public-safe demo context for a fictional local AI developer workstation.
