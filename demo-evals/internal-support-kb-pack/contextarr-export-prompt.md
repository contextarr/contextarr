...
Task: answer the pack-specific demo question for Internal Support KB Pack.

Use only this scoped Contextarr export summary for pack internal-support-kb-pack.

Sources:

- records/overview.md: Public-safe demo context for a fictional internal support knowledge base.
