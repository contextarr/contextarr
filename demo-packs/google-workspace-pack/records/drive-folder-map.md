---
id: google-workspace-pack.drive-folder-map
title: Drive Folder Map
type: workspace_note
...
sources:
  - google-workspace-pack-drive-folder-map-source
...
Drive Folder Map describes a fictional team workspace with local notes about Drive, Docs, Sheets, Calendar, and sharing conventions. It gives operators who want AI to understand workspace rules without giving it connector access a reviewed, local, public-safe context record that can be rendered for humans and reused in target-specific AI briefs.

## Key Facts

| Area | Demo detail | Why it matters |
| --- | --- | --- |
| Scope | Top folders use purpose labels: Operations, Projects, Support, Finance-Safe, and Archive. | Keeps the pack specific without exposing private operational data. |
| Review use | Restricted folders are mentioned only by category. | Keeps the pack specific without exposing private operational data. |
| AI value | Folder ownership is documented as role-based, not person-based. | Keeps the pack specific without exposing private operational data. |
...
- Record ID: `google-workspace-pack.drive-folder-map`
