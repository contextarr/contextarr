---
id: obsidian-vault-pack.folder-map
title: Folder Map
...
sources:
  - obsidian-vault-pack-folder-map-source
...
Folder Map describes a fictional Markdown vault called Atlas Notes with local knowledge, daily notes, and export rules. It gives Obsidian and Markdown users turning notes into reviewed AI context a reviewed, local, public-safe context record that can be rendered for humans and reused in target-specific AI briefs.

## Key Facts

| Area | Demo detail | Why it matters |
| --- | --- | --- |
| Scope | Folder roles define source reliability and export defaults. | Keeps the pack specific without exposing private operational data. |
| Review use | Inbox and Daily are draft-only until promoted. | Keeps the pack specific without exposing private operational data. |
| AI value | Archive notes remain searchable locally but excluded from default briefs. | Keeps the pack specific without exposing private operational data. |
...
- Record ID: `obsidian-vault-pack.folder-map`
